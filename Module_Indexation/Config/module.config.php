...
return [
    ...
    'js_translate_strings' => [
        'Supprimer le Mapping ', // @translate
        'Annuler le Mapping', // @translate
        'Sélectionnez un type d"élément à gauche avant de choisir une classe de ressources.', // @translate
        'Sélectionnez un élément à gauche avant de choisir une propriété.', // @translate
        'Veuillez entrer une étiquette de langue valide.', // @translate
    ],
];
